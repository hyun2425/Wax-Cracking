...
function ThreeWalkWorld({
  ...
  useEffect(() => {
    ...
    poopPile.position.set(phase === "poop" ? 2.28 : 1.02, 0.08, phase === "poop" ? -2.84 : -1.72);
  ...
  return (
    <div className="poop-ui">
      ...
      <style jsx>{`
        ...
        .poop-hotspot { position: absolute; left: 66%; bottom: 258px; width: 188px; height: 144px; transform: translateX(-50%); display: grid; place-items: center; pointer-events: auto; }

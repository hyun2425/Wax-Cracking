...
function ThreeWalkWorld({
  ...
  useEffect(() => {
    ...
    poopPile.position.set(phase === "poop" ? 1.42 : 1.02, 0.07, phase === "poop" ? -1.38 : -1.72);
  ...
  return (
    <div className="poop-ui">
      ...
      <style jsx>{`
        ...
        .poop-hotspot { position: absolute; left: 57%; bottom: 116px; width: 190px; height: 150px; transform: translateX(-50%); display: grid; place-items: center; pointer-events: auto; }

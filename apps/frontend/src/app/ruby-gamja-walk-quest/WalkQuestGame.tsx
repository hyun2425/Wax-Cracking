...
function ThreeWalkWorld({
  ...
  useEffect(() => {
    ...
    poopPile.position.set(phase === "poop" ? 1.55 : 1.02, 0.07, phase === "poop" ? -1.42 : -1.72);
  ...
  return (
    <div className="poop-ui">
      ...
      <style jsx>{`
        ...
        .poop-hotspot { position: absolute; left: 62%; bottom: 248px; width: 138px; height: 116px; transform: translateX(-50%); display: grid; place-items: center; pointer-events: auto; }
